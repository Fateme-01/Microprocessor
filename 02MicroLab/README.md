...
led اسم متغیر است و به پایه ی 12بورد متصل است.
* void setup()
...
این تابع متغیر ledراکه شماره ی پایه در آن است را به عنوان خروجی در نظر می گیرد.
...
ابتدا هردو LEDرا روی برد بورد متصل کرده و پایه های مثبت آنها را با یک جامپر به پایه ی 12و13 بورد متصل می کنیم.
 ...
 پایه ی منفی هردو LED را به دو مقاومت 220اهمی متصل می کنیم.
...
کلمه int چون به متغیر یک مقدار عددی داده ایم استفاده شده.LEDاسم متغیر است  و 13پایه ای از بورد است که LEDبه آن متصل است.
*int LED = 12;
...
ابتدا هردو LEDرا روی برد بورد متصل کرده و پایه های مثبت آنها را با یک جامپر به پایه ی 12و13 بورد متصل می کنیم.
 ...
 بورد آردوینو را با کابل به سیستم وصل می کنیم و برنامه را کامپایل و سپس آپلود میکنیم و در نهایت یکی از LEDها با تناوب یک ثانیه روشن و دیگری خاموش می شود.
 
## آزمایش شماره سه: تناوب روشن 5ثانیه و تناوب خاموش 0.5ثانیه
## تجهیزات مورد نیاز:
* بورد Arduino uno
* دوعدد LED
* دو مقاومت 220اهم
...
این تابع قابلیت تنظیم یک زمان مشخص برای هر دستور را دارد. این تابع بر حسب میلی ثانیه است و این دستور LEDرا به مدت پنج ثانیه روشن نگه می دارد.
*digitalWrite (led, LOW);

این تابع با گرفتن شماره پایه در قسمت اول و HIGHیا LOW بودن آن در قسمت دوم به صرت دیجیتال روشن و ختموش شدن LEDرا مشخص و کنترل می کند.
* delay (500);
  
  این تابع به مدت 500میلی ثانیه LEDرا خاموش نگه میدارد.
  ## توضیح آزمایش (قسمت سخت افزاری):
ابتدا هردو LEDرا روی برد بورد متصل کرده و پایه های مثبت آنها را با یک جامپر به پایه ی 12و13 بورد متصل می کنیم.
 ...
 بورد آردوینو را با کابل به سیستم وصل می کنیم و برنامه را کامپایل و سپس آپلود میکنیم و در نهایت هردو LEDبه مدت 5ثانیه روشن و 0.5ثانیه خاموش می شوند .
